/*Vision of future everyday house
 * 
...
void MBFOFF(){
 ...
 myservo.write(0); 
  ...
  delay(1000);
  mySerial.println("AT + CMGS = \"+880XXXXXXXXXX\"\r");//send sms message, be careful need to add a country code before the cellphone number
  delay(1000);
  ...
  mySerial.println("AT + CMGS = \"+880XXXXXXXXXX\"\r");//send sms message, be careful need to add a country code before the cellphone number
  delay(1000);
  mySerial.println("Emergency alert Anamika's Villa.");//the content of the message
  delay(100);
  mySerial.println((char)26);//the ASCII code of the ctrl+z is 26
  delay(100);
  mySerial.println(); 
